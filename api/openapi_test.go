...
func TestOpenAPIContract(t *testing.T) {
	...
	for _, path := range []string{"/api/config", "/api/openapi.yaml", "/swagger", "/health/live", "/health/ready", "/api/session", "/api/session-tokens"} {
...
func TestImplementedResponsesMatchOpenAPI(t *testing.T) {
	...
	tests := []struct {
		...
		{"browser placeholder", http.MethodPost, "/api/session", `{"username":"someone","password":"placeholder"}`, "application/json", http.StatusNotImplemented},
		{"token placeholder", http.MethodPost, "/api/session-tokens", `{"username":"someone","password":"placeholder"}`, "application/json", http.StatusNotImplemented},
		{"current placeholder", http.MethodGet, "/api/session", "", "", http.StatusNotImplemented},
		{"signout placeholder", http.MethodDelete, "/api/session", "", "", http.StatusNotImplemented},
